...
- javascript, lua, perl, php, ruby: fix return value of function hdata_longlong
...
- core: improve speed of `/upgrade` with a lot of buffers and lines ([#2338](https://github.com/weechat/weechat/issues/2338), [#2339](https://github.com/weechat/weechat/issues/2339), [#2341](https://github.com/weechat/weechat/issues/2341))
...
- core: add tests on URL, bar and key functions
...
- core: add tests on gui input functions
...
- doc: add Spanish FAQ ([#1656](https://github.com/weechat/weechat/issues/1656))
- doc: add Serbian translations ([#1655](https://github.com/weechat/weechat/issues/1655))
...
- core: do not build weechat-headless man page if headless binary is disabled ([#1607](https://github.com/weechat/weechat/issues/1607))
...
- doc: merge 53 auto-generated files into 11 files
...
- doc: fix broken literal blocks in Japanese docs with Firefox ([#1466](https://github.com/weechat/weechat/issues/1466))
...
- doc: switch to asciidoctor to build docs and man page ([#722](https://github.com/weechat/weechat/issues/722))
...
- doc: add Czech man page and quickstart guide ([#490](https://github.com/weechat/weechat/issues/490))
...
- doc: replace PREFIX with CMAKE_INSTALL_PREFIX in CMake instructions ([#354](https://github.com/weechat/weechat/issues/354))
...
- doc: update man page and add translations (in French, German, Italian, and Japanese)
...
- doc: add Japanese user's guide ([patch #7827](https://savannah.nongnu.org/patch/?7827)), scripting guide and tester's guide
...
- doc: add Japanese FAQ ([patch #7781](https://savannah.nongnu.org/patch/?7781))
...
- doc: add developer's guide ([task #5416](https://savannah.nongnu.org/task/?5416))
...
- core: add color "darkgray", add support for background with light color
