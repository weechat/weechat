...
image:https://img.shields.io/badge/mastodon%2B-follow-blue.svg["Mastodon", link="https://hostux.social/@weechat"]
image:https://img.shields.io/badge/twitter%2B-follow-blue.svg["Twitter", link="https://twitter.com/WeeChatClient"]
