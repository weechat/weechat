...
Sollte die Option irc.network.whois_double_nick aktiviert sein, wird ein Nick zweimal verwendet (sofern der Nick nur einmal angegeben wurde), um die Idle-Zeit zu erhalten.
----
