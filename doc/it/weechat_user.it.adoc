...
include::includes/key_bindings.it.adoc[]
...
nei mask (consultare `man strftime` per i formati, extra specifiers are supported, see link:weechat_plugin_api.it.html#_util_strftimeval[WeeChat plugin API reference / util_strftimeval ^↗^^]),
ad esempio:
