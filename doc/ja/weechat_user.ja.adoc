...
include::includes/key_bindings.ja.adoc[]
...
(書式に関しては `man strftime` を参照してください, extra specifiers are supported, see link:weechat_plugin_api.ja.html#_util_strftimeval[WeeChat plugin API reference / util_strftimeval ^↗^^])。例えば:
