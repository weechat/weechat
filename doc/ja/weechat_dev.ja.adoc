...
// TRANSLATION MISSING
|          calc-fuzzer.cc                         | Fuzz testing: calculation of expressions.
// TRANSLATION MISSING
|          crypto-fuzzer.cc                       | Fuzz testing: cryptographic functions.
// TRANSLATION MISSING
|          eval-fuzzer.cc                         | Fuzz testing: evaluation of expressions.
// TRANSLATION MISSING
|          secure-fuzzer.cc                       | Fuzz testing: secured data.
// TRANSLATION MISSING
|          string-fuzzer.cc                       | Fuzz testing: 文字列
// TRANSLATION MISSING
|          utf8-fuzzer.cc                         | Fuzz testing: UTF-8.
// TRANSLATION MISSING
|          util-fuzzer.cc                         | Fuzz testing: utility functions.
...
// TRANSLATION MISSING
|             test-xfer.cpp                       | Tests: xfer functions.
// TRANSLATION MISSING
...
// TRANSLATION MISSING
|       weechat_cheatsheet.XX.adoc              | link:weechat_cheatsheet.ja.html[Cheat sheet ^↗^^].
