...
WeChat (Web Enhanced Окружающая среда для чат) это свободным чат-клиент, быстрый и легкий, 
он предназначен для многих операционных систем. 
Он легко настраиваемый, кроме того, вы можете расширить его функицонал при помощи скриптов.
