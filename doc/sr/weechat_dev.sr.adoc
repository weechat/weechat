...
// TRANSLATION MISSING
|          script/   | Unit tests for script plugin.
...
// TRANSLATION MISSING
|    core-theme.c               | Themes (bundles of option overrides).
// TRANSLATION MISSING
|    core-theme-builtin.c       | Built-in themes: core options.
...
| gui/                          | Функције за бафере, прозоре, ... (користе их сви интерфејси).
// TRANSLATION MISSING
|    gui-bar-item-custom.c      | Custom bar items.
...
// TRANSLATION MISSING
|       spell-theme.c                | Spell checker contribution to built-in themes.
|    buflist/                        | Buflist додатак.
...
// TRANSLATION MISSING
|       buflist-theme.c              | Buflist contribution to built-in themes.
|    charset/                        | Charset додатак.
...
// TRANSLATION MISSING
|       exec-theme.c                 | Exec contribution to built-in themes.
|    fifo/                           | Fifo додатак.
...
// TRANSLATION MISSING
|       fset-theme.c                 | Fset contribution to built-in themes.
...
// TRANSLATION MISSING
|       irc-theme.c                  | IRC contribution to built-in themes.
...
// TRANSLATION MISSING
|       logger-theme.c               | Logger contribution to built-in themes.
|    lua/                            | Lua додатак.
...
// TRANSLATION MISSING
|       relay-theme.c                | Relay contribution to built-in themes.
...
// TRANSLATION MISSING
|       script-theme.c               | Script manager contribution to built-in themes.
|    tcl/                            | Tcl додатак.
...
// TRANSLATION MISSING
|       trigger-theme.c              | Trigger contribution to built-in themes.
|    typing/                         | Typing додатак.
...
// TRANSLATION MISSING
|       xfer-theme.c                 | Xfer contribution to built-in themes.
...
// TRANSLATION MISSING
|          eval-fuzzer.cc                         | Fuzz testing: evaluation of expressions.
...
// TRANSLATION MISSING
|          test-core-theme.cpp                    | Tests: themes.
...
// TRANSLATION MISSING
|             test-gui-curses-term.cpp            | Tests: terminal functions (Curses interface).
...
// TRANSLATION MISSING
|             test-relay-client.cpp               | Tests: clients of relay.
...
// TRANSLATION MISSING
|          script/                                | Root of unit tests for script plugin.
// TRANSLATION MISSING
|             test-script-repo.cpp                | Tests: script repository.
...
// TRANSLATION MISSING
|             test-xfer-chat.cpp                  | Tests: DCC chat.
...
| doc/                                          | Документација.
// TRANSLATION MISSING
|    cheatsheet.css                             | Asciidoctor style for the cheat sheet.
|    docinfo.html                               | Asciidoctor стил.
|    XX/                                        | Документација за језик XX (језици: en, fr, de, it, ...).
|       weechat.1.XX.adoc                       | Man страница(`man weechat`).
// TRANSLATION MISSING
|       weechat_cheatsheet.XX.adoc              | link:weechat_cheatsheet.sr.html[Cheat sheet ^↗^^].
...
// TRANSLATION MISSING
|          key_bindings.XX.adoc                 | Key bindings (file included in user's guide and cheat sheet).
...
// TRANSLATION MISSING
** Comment must start with a capital letter except for identifiers.
// TRANSLATION MISSING
** A complete sentence must end with a period.
// TRANSLATION MISSING
** Comments describing fields of a struct can be lower case only.
