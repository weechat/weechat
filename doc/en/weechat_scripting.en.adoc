...
# For other languages, change "python" with your language (perl/ruby/lua/tcl/guile/javascript/php).
----
...
# It is useful here to use "*" as server, to catch JOIN messages on all IRC servers.
