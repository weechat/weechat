...
# initialize with hashed password "test" (SHA256: salt="nonce:cnonce") (WeeChat ≥ 2.9)
init password_hash=sha256:6e6f6e63653a636e6f6e6365:763c9dca0737e1ca57eb9fc2f61f184550d8d5e8e66c0568a202abb23811771d

# initialize with hashed password "test" (SHA512: salt="nonce:cnonce") (WeeChat ≥ 2.9)
...
# initialize with hashed password "test" (PBKDF2: SHA256, salt="nonce:cnonce", 100000 iterations) (WeeChat ≥ 2.9)
