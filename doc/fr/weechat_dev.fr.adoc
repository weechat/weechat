...
|          script/   | Tests unitaires pour l'extension script.
...
|    core-theme.c               | Thèmes (ensembles de surcharges d'options).
|    core-theme-builtin.c       | Thèmes intégrés : options du cœur.
...
|    gui-bar-item-custom.c      | Objets de barre personnalisés.
...
|       buflist-theme.c              | Contribution de Buflist aux thèmes intégrés.
|    charset/                        | Extension Charset.
...
|       exec-theme.c                 | Contribution de Exec aux thèmes intégrés.
|    fifo/                           | Extension Fifo.
...
|       fset-theme.c                 | Contribution de Fset aux thèmes intégrés.
...
|       irc-theme.c                  | Contribution d'IRC aux thèmes intégrés.
...
|       logger-theme.c               | Contribution de Logger aux thèmes intégrés.
|    lua/                            | Extension Lua.
...
|       relay-theme.c                | Contribution de Relay aux thèmes intégrés.
...
|       script-theme.c               | Contribution du gestionnaire de scripts aux thèmes intégrés.
|    spell/                          | Extension Spell.
...
|       spell-theme.c                | Contribution de Spell aux thèmes intégrés.
|    tcl/                            | Extension Tcl.
...
|       trigger-theme.c              | Contribution de Trigger aux thèmes intégrés.
|    typing/                         | Extension Typing.
...
|       xfer-theme.c                 | Contribution de Xfer aux thèmes intégrés.
...
|          calc-fuzzer.cc                         | Fuzzing : calcul d'expressions.
|          crypto-fuzzer.cc                       | Fuzzing : fonctions cryptographiques.
|          eval-fuzzer.cc                         | Fuzzing : évaluation d'expressions.
|          secure-fuzzer.cc                       | Fuzzing : données sécurisées.
|          string-fuzzer.cc                       | Fuzzing : chaînes.
|          utf8-fuzzer.cc                         | Fuzzing : UTF-8.
|          util-fuzzer.cc                         | Fuzzing : fonctions utiles.
...
|          test-core-theme.cpp                    | Tests : thèmes.
...
|             test-gui-curses-term.cpp            | Tests : fonctions pour le terminal (interface Curses).
...
|             test-irc-completion.cpp             | Tests : complétions IRC.
...
|             test-relay-client.cpp               | Tests : clients du relai.
...
|                remote/                          | Tests : protocole relay "api" : fonctions "remote".
|                   test-relay-remote-event.cpp   | Tests : protocole relay "api" : évènements "remote".
|                   test-relay-remote-network.cpp | Tests : protocole relay "api" : réseau "remote".
|             irc/                                | Racine des tests unitaires pour le protocole relay "irc".
|                test-relay-irc.cpp               | Tests : protocole relay "irc".
|          script/                                | Racine des tests unitaires pour l'extension script.
|             test-script-repo.cpp                | Tests : dépôt de scripts.
...
|             test-xfer.cpp                       | Tests : fonctions xfer.
|             test-xfer-chat.cpp                  | Tests : discussion DCC.
...
| Chemin/fichier                                | Description
| doc/                                          | Documentation.
|    cheatsheet.css                             | Style Asciidoctor pour l'aide-mémoire.
...
|       weechat_cheatsheet.XX.adoc              | link:weechat_cheatsheet.fr.html[Aide-mémoire ^↗^^].
...
|          key_bindings.XX.adoc                 | Raccourcis clavier (fichier inclus dans le guide utilisateur et l'aide-mémoire).
...
* Utilisez les commentaires `+/* comment */+` (pas de style C99 comme
  `+// comment+`) :
** Le commentaire doit démarrer par une lettre capitale sauf pour les identifiants.
** Une phrase complète doit se terminer par un point.
** Les commentaires décrivant les champs d'une structure peuvent être en minuscules seulement.
