...
le sel est le nonce _relay_ + "ABCD" ("41424344" en hexadécimal), le mot de passe
est "test" dans cet exemple :
...
# initialiser avec le mot de passe haché "test" (SHA256 : sel="nonce:cnonce") (WeeChat ≥ 2.9)
init password_hash=sha256:6e6f6e63653a636e6f6e6365:763c9dca0737e1ca57eb9fc2f61f184550d8d5e8e66c0568a202abb23811771d

# initialiser avec le mot de passe haché "test" (SHA512 : sel="nonce:cnonce") (WeeChat ≥ 2.9)
...
# initialiser avec le mot de passe haché "test" (PBKDF2 : SHA256, sel="nonce:cnonce", 100000 itérations) (WeeChat ≥ 2.9)
