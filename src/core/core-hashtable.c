...
static const char *const hashtable_type_string[HASHTABLE_NUM_TYPES] = {
    [HASHTABLE_INTEGER] = WEECHAT_HASHTABLE_INTEGER,
    [HASHTABLE_STRING] = WEECHAT_HASHTABLE_STRING,
    [HASHTABLE_POINTER] = WEECHAT_HASHTABLE_POINTER,
    [HASHTABLE_BUFFER] = WEECHAT_HASHTABLE_BUFFER,
    [HASHTABLE_TIME] = WEECHAT_HASHTABLE_TIME,
    [HASHTABLE_LONGLONG] = WEECHAT_HASHTABLE_LONGLONG,
};
