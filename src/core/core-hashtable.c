 ...
 *
 * Do not check/adjust the load factor: this is also called in a loop by
 ...
 *
 * Also shrink the internal array (see hashtable_rehash) if the average
 ...
 *
 * Do not shrink the internal array: callers typically clear a hashtable
