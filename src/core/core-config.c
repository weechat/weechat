    ...
    if (weechat_config_section_look)
    {
        ...
        config_look_day_change_message_1date = config_file_new_option (
            ...
            N_("message displayed when the day has changed, with one date "
               ...
               "strftime for date/time specifiers, extra specifiers are "
               "supported, see function util_strftimeval in Plugin API "
               "reference) (note: content is evaluated, so you can use colors "
        ...
        config_look_day_change_message_2dates = config_file_new_option (
            ...
            N_("message displayed when the day has changed, with two dates "
               ...
               "must start with two \"%\" because the date/time specifiers "
               "are replaced two times in this string (see man strftime for "
               "date/time specifiers, extra specifiers are supported, see "
