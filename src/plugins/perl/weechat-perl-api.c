...
const char *
weechat_perl_api_hook_provider_cb (void *data, const char *provider,
...
API_FUNC(hook_provider)
{
    ...
    provider = SvPV_nolen (ST (0));
    function = SvPV_nolen (ST (1));
    data = SvPV_nolen (ST (2));

    result = API_PTR2STR(plugin_script_api_hook_provider (weechat_perl_plugin,
                                                          perl_current_script,
                                                          provider,
                                                          &weechat_perl_api_hook_provider_cb,
                                                          function,
                                                          data));
