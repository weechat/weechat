...
const zend_function_entry weechat_functions[] = {
    ...
    PHP_FE(weechat_infolist_new_var_long, arginfo_weechat_infolist_new_var_long)
    PHP_FE(weechat_infolist_new_var_longlong, arginfo_weechat_infolist_new_var_longlong)
    ...
    PHP_FE(weechat_infolist_long, arginfo_weechat_infolist_long)
    PHP_FE(weechat_infolist_longlong, arginfo_weechat_infolist_longlong)
