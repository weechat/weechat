...
PHP_FUNCTION(weechat_infolist_new_var_long);
PHP_FUNCTION(weechat_infolist_new_var_longlong);
...
PHP_FUNCTION(weechat_infolist_long);
PHP_FUNCTION(weechat_infolist_longlong);
