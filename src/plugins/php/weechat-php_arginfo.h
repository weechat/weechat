...
#define arginfo_weechat_infolist_long arginfo_weechat_string_has_highlight

#define arginfo_weechat_infolist_longlong arginfo_weechat_string_has_highlight
