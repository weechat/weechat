                          ...
                          const char *reply)
{
    ...
    weechat_printf_date_tags (
        ...
        _("%sCTCP requested by %s%s%s @ %s%s%s: %s%s%s%s%s%s"),
        ...
        if (pos_space)
        {
            ...
            if (strcmp (arguments + 1, "PING") == 0)
            {
                ...
                if (pos_usec)
                {
                    ...
                    weechat_printf_date_tags (
                        ...
                        _("%sCTCP reply from %s%s%s @ %s%s%s: %s%s%s %.3fs"),
                        weechat_prefix ("network"),
                        irc_nick_color_for_msg (server, 0, NULL, nick),
                        nick,
                        IRC_COLOR_RESET,
            ...
            else
            {
                weechat_printf_date_tags (
                    ...
                    date,
                    irc_protocol_tags (command, "irc_ctcp", NULL, address),
                    _("%sCTCP reply from %s%s%s @ %s%s%s: %s%s%s%s%s"),
                    weechat_prefix ("network"),
                    irc_nick_color_for_msg (server, 0, NULL, nick),
                    nick,
                    IRC_COLOR_RESET,
            ...
            while (1)
            {
                ...
                weechat_printf_date_tags (
                    ...
                    irc_protocol_tags (
                        ...
                        "no_highlight",
                        NULL, NULL),
                    _("%sCTCP reply to %s%s%s @ %s%s%s: %s%s%s%s%s"),
                    weechat_prefix ("network"),
                    irc_nick_color_for_msg (server, 0, NULL, nick),
                    nick,
                    IRC_COLOR_RESET,
            ...
            else
            {
                if (weechat_config_boolean (irc_config_look_display_ctcp_unknown))
                {
                    weechat_printf_date_tags (
                        ...
                        date,
                        irc_protocol_tags (command, "irc_ctcp", NULL, address),
                        _("%sUnknown CTCP requested by %s%s%s @ %s%s%s: %s%s%s%s%s"),
                        weechat_prefix ("network"),
                        irc_nick_color_for_msg (server, 0, NULL, nick),
                        nick,
                        IRC_COLOR_RESET,
