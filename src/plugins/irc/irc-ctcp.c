                          ...
                          const char *reply)
{
    ...
    weechat_printf_date_tags (
        ...
        irc_nick_color_for_msg (server, channel, 0, NULL, nick),
        nick,
        IRC_COLOR_RESET,
            ...
            if (strcmp (arguments + 1, "PING") == 0)
            {
                ...
                if (pos_usec)
                {
                    ...
                    weechat_printf_date_tags (
                        ...
                        weechat_prefix ("network"),
                        irc_nick_color_for_msg (server, NULL, 0, NULL, nick),
                        nick,
                        IRC_COLOR_RESET,
                        IRC_COLOR_CHAT_CHANNEL,
                        arguments + 1,
        ...
        if (strcmp (arguments + 1, "ACTION") == 0)
        {
            ...
            if (channel)
            {
                ...
                weechat_printf_date_tags (
                    ...
                    (ptr_nick) ? ptr_nick->color :
                        ((nick) ? irc_nick_find_color (server, channel, nick) : IRC_COLOR_CHAT_NICK),
                    nick,
