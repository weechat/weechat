    ...
    for (i = 0; i < num_targets; i++)
    {
        ...
        if (ctcp_target)
        {
            ...
            weechat_printf (
                ...
                irc_nick_color_for_msg (ptr_server, NULL, 0, NULL, ctcp_target),
                ctcp_target,
                IRC_COLOR_RESET,
            ...
            else
            {
                ...
                if (hide_password)
                {
                    ...
                    weechat_printf (
                        ...
                        weechat_prefix ("network"),
                        IRC_COLOR_CHAT_DELIMITERS,
                        irc_nick_color_for_msg (ptr_server, NULL, 0, NULL,
                                                targets[i]),
                        targets[i],
                        IRC_COLOR_CHAT_DELIMITERS,
                        IRC_COLOR_RESET,
                    ...
                    else
                    {
                        weechat_printf_tags (
                            ...
                            irc_nick_color_for_msg (
                                ptr_server, NULL, 0, NULL, targets[i]),
                            targets[i],
                            IRC_COLOR_CHAT_DELIMITERS,
                            IRC_COLOR_RESET,
                            (string) ? string : argv_eol[arg_text]);
    ...
    if (hashtable)
    {
        ...
        while (1)
        {
            ...
            weechat_printf_tags (
                ...
                _("Notice"),
                IRC_COLOR_RESET,
                (is_channel) ? IRC_COLOR_CHAT_CHANNEL :
                    irc_nick_color_for_msg (ptr_server, ptr_channel, 0, NULL, argv[arg_target]),
                argv[arg_target],
                IRC_COLOR_RESET,
    ...
    if (weechat_strcasecmp (argv[1], "add") == 0)
    {
        ...
        if (ptr_notify)
        {
            ...
            weechat_printf (
                ...
                IRC_PLUGIN_NAME,
                irc_nick_color_for_msg (ptr_server, NULL, 1, NULL, ptr_notify->nick),
                ptr_notify->nick,
                weechat_color ("reset"));
        ...
        else
        {
            ...
            if (ptr_notify)
            {
                weechat_printf (
                    ...
                    IRC_PLUGIN_NAME,
                    irc_nick_color_for_msg (ptr_server, NULL, 1, NULL,
                                            ptr_notify->nick),
                    ptr_notify->nick,
                    weechat_color ("reset"));
