...
#define IRC_COLOR_MESSAGE_KICK                                                \
    ((!weechat_config_option_is_null (irc_config_color_message_kick)) ?       \
...
#define IRC_COLOR_REASON_KICK                                                \
    ((!weechat_config_option_is_null (irc_config_color_reason_kick)) ?       \
        weechat_color(weechat_config_string(irc_config_color_reason_kick)) : \
