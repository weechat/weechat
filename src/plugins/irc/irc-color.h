...
#define IRC_COLOR_ITEM_TLS_VERSION_MAX weechat_color(weechat_config_string(irc_config_color_item_tls_version_max))
#define IRC_COLOR_ITEM_TLS_VERSION_1_2 weechat_color(weechat_config_string(irc_config_color_item_tls_version_1_2))
#define IRC_COLOR_ITEM_TLS_VERSION_OTHER weechat_color(weechat_config_string(irc_config_color_item_tls_version_other))
